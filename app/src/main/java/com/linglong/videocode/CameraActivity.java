...
public class CameraActivity extends AppCompatActivity implements SurfaceHolder.Callback, Camera.PreviewCallback {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                switch (motionEvent.getAction()){
                    ...
                    case MotionEvent.ACTION_UP:
                        stop();
                        //record.stopRecord();
                       /* String path = record.getFilePath2();
                        Intent intent= new Intent();
                        intent.setClass(CameraActivity.this,PlayVideoActivity.class);
    ...
    private void start(){
        ...
        record.prepare(optimalPreviewSize.width,optimalPreviewSize.height,null);
        record.startRecord();
    }
